...
sub init{
	...
	print "\nDie automatische Konfiguration ihres Servers wird nun gestartet\n";
	print "Bitte geben Sie das Passwort ein, dass sie von pcvisit per Mail erhalten haben:\t";
	
	# passwort vom nutzer entgegennehmen
	ReadMode 2;
